...
import EditCarinfos from "./EditCarinfos";
...
export default function ManageProduct() {
  ...
  const handleedit = () => {
    editProductDB(cars.id);
    {
      <EditCarinfos value={cars.id}/>
    }
    naviagate("/editinfos");
  };
  
  if (!cars)
    return <h1 className="text-center text-gray-500">fjkhdjfkhsaldfasd</h1>;
